const i18n = {
  messages: {
    ...
    'ja-jp': {
      ...
      'Feeds (CSV)': 'フィード (CSV)',
      'Rolling time': '',
      'Rolling time (in minutes)': '',
      'Include headers in the feed': 'フィード内のヘッダーを含める',
      Separator: 'セパレーター',
      Column: '',
      Columns: '',
      'Data sharing': 'データ共有',
      ...
      Renew: '',
      Authentication: '',
      'Total pending inserts': '',
      'Relations to threats': '',
      'Relations to other entities': '',
      'Context relations': '',
      'Direct relations creations': '',
