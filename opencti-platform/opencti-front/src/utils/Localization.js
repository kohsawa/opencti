const i18n = {
  messages: {
    ...
    'ja-jp': {
      ...
      'Add observables': '観測結果（Observables）の追加',
      'Add observable': '観測結果（Observable）の追加',
      ...
      'Export as PDF': 'PDF出力',
      'Merge entities': 'エンティティの統合',
      'Selected entities': '選択したエンティティ',
      'Merged entity': '統合されたエンティティ',
      ...
      'No import connectors on this platform':
        '有効なインポート用コネクタがない',
      'No connectors for this type of entity':
        'このタイプのエンティティ用のコネクタがない',
      'This connector is active': 'アクティブなコネクタ',
      'This connector is disconnected': 'このコネクタとの接続が切れている',
      'Reset the connector state': 'コネクタの状態を初期化',
      ...
      'Regions, countries and cities': '地域、国家と都市',
      ...
      'Platform favicon URL': 'favironのURL',
      ...
      'Indicators composed with this observable':
        'この観測結果から得られたインジケータ',
      'You must provide at least one external reference for this type of entity':
        'このタイプのエンティティは最低1個の外部参照を含む必要がある',
      Overview: '概要',
      View: '表示',
      Relationships: '関連 (Relationships)',
      Entities: 'エンティティ',
      'entitie(s)': 'エンティティ',
      Observables: '観測結果 (Observables)',
      Artifacts: 'アーティファクト',
      Infrastructures: 'インフラストラクチャ',
      Sightings: '目撃 (Sightings)',
      ...
      'Used TTPs': '使用されたTTPs',
      'The code is not correct': 'コードが正しくない',
      'Type the code generated in your application':
      ...
      Graph: 'グラフ',
      'Techniques matrix': '戦術マトリックス',
      'Targeting knowledge': 'ターゲットに関する知識',
      'TTPs knowledge': 'TTPsに関する知識',
      Compare: '比較',
      'Threats targeting': '驚異のターゲット',
      'TTPs of threats': '驚異の用いるTTPs',
      'Number of': '番号',
      Number: '番号',
      Count: '合計',
      'Top 10:': 'Top 10:',
      ...
      'Threat or arsenal item': '驚異または武器庫のアイテム',
      'Display data about intrusion sets, malwares, tools, etc.':
      ...
      Configuration: '配置',
      Victimology: '被害者',
      'Victimology (countries)': '被害者 (国)',
      'Victimology (regions)': '被害者 (地域)',
      'Victimology (sectors)': '被害者 (セクター)',
      'Used tools': '使用されたツール',
      ...
      'All observables': '観測記録 (Observables)',
      ...
      'Attributed to this actor': 'この驚異アクターに帰属するもの',
      'Targeted by this actor': 'この驚異アクターの標的もの',
      'Used by this actor': 'この驚異アクターに使用されたもの',
      'Targeting this sector': 'このセクターを標的にしているもの',
      'Affecting this sector': 'このセクターに影響があるもの',
      'Part of this sector': 'このセクターの一部',
      'Origins of this intrusion set': 'この侵入セットの起源',
