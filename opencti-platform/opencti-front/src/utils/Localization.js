const i18n = {
  messages: {
    ...
    'ja-jp': {
      ...
      'You do not have any access to the knowledge of this OpenCTI instance.':
        'この OpenCTI インスタンスのナレッジデータにアクセスする権限がありません',
      'Write something awesome...': 'すごいことを書いて...',
      // Dependencies
      Grakn: 'Grakn',
      Elasticsearch: 'Elasticsearch',
      RabbitMQ: 'RabbitMQ',
      ...
      'Authentication strategies': '認証戦略',
      ...
      Light: '明',
      Dark: '暗',
      'Light (with background)': '明 (背景有り)',
      'Light (without background)': '明 (背景無し)',
      ...
      Cancel: 'キャンセル',
      Import: 'インポート',
      'No files in this category.': 'この分類に該当するファイルはありません',
      'Text files': 'テキストファイル',
      'HTML files': 'HTMLファイル',
      'PDF files': 'PDFファイル',
      ...
      'This individual is now a user':
        'この個人が現在のユーザーです',
      'This relation is inferred': 'この関連が推測されました',
      ...
      'Create a user': 'ユーザを作成',
      'Update a user': 'ユーザを更新',
      ...
      'Create a synchronizer': '同期を作成',
      'Update a synchronizer': '同期を更新',
      ...
      'Create an indicator from this observable':
        '観測結果からインジケータを作成',
      'Create a relationship': '関連を作成',
      'Create a nested relationship': '階層化された関連を作成する',
      'Update a relationship': '関連を更新',
      'Select a relationship': '関連を選択',
      'Create a sighting': '目撃を作成',
      'Update a sighting': '目撃を更新',
