const i18n = {
  messages: {
    ...
    'ja-jp': {
      ...
      History: 'ヒストリー',
      'Files & history': 'ファイルとヒストリー',
      'External references files': '外部参考資料',
      to: 'To',
      ...
      'No history about this entity.':
        'このエンティティにはヒストリーがありません',
      'No relations history about this entity.':
        'このエンティティにはリレーションヒストリーがありません',
      ...
      'Explore the victims and the targets of the dataset through space and time.':
        '犠牲者とターゲットを場所と時間から探す',
      'Explore the attack campaigns of the dataset through time and involved entities.':
        '攻撃キャンペーンを時間と含まれるエンティティから探す',
      'Explore the techniques, tactics and procedures of the dataset through time and entities who used its.':
        'TTPs を時間と使用したアクターのエンティティから探す',
      'Explore the kill chains of entities through time and other contextual information like campaigns or incidents.':
        'キルチェーンを、キャンペーンやインシデントのような文脈情報と時間から探す',
      'Explore the vulnerabilities used by entities through time and kill chain phases.':
        '脆弱性を時間と使用されたキルチェーンのフェーズから探す',
      'Explore the observables of the dataset though time to visualize clusters and correlations.':
        '観測結果を時間と視覚化されたクラスター/相関性からから探す',
      'Origins of the targeting': 'ターゲッティングの起点',
      'Types of the targeting': 'ターゲッティングのタイプ',
      'Types of the targets': '標的のタイプ',
      'Targeted entity types': '標的となったエンティティタイプ',
      'Targeted entity through time': '時間で見た標的となったエンティティ',
      'Number of targeting': 'ターゲッティングの数',
      'Related entities (generic relation "related-to")':
        '関連するエンティティ (一般的なリレーションは "related-to")',
      'This panel shows by default the latest created entities, use the search to find more.':
      ...
      'Reference modification': 'リファレンスの変更',
      'Required permissions': '必要な権限',
      'Enable commit messages': 'コミットメッセージの有効化',
      'Commit message when updating data from the UI.':
        'UIからデータを更新したときのコミットメッセージ',
      'To use this feature, your platform administrator must enable the subscription manager in the config.':
        'この機能を使用するためには、プラットフォーム管理者がコンフィグでサブスクリプションマネージャーを有効にする必要があります',
      'To use this feature, your platform administrator must enable the rule engine in the config.':
        'この機能を使用するためには、プラットフォーム管理者がコンフィグでルールエンジンを有効にする必要があります',
      'In OpenCTI, a predictable STIX ID is generated based on one or multiple attributes of the entity.':
        'OpenCTIでは、1つまたは複数のアトリビュートから予測可能なSTIX IDが生成されます',
      None: 'N/A',
      Nonee: 'N/A',
      Status: 'ステータス',
      ...
      'Observables and indicators conversion':
        '観測結果とインディケータの交換',
      'This action will generate observables from the selected indicators.':
        'この操作によって選択されたインディケータから観測結果が生成されます',
      'This action will generate STIX patterns indicators from the selected observables.':
        'この操作によって選択された観測結果からSTIXパターンインディケータを生成します',
      'Indicators/observables generation':
        'インディケータ/観測結果の生成',
      Generate: '生成',
      // Time
      ...
      'entity_stix-core-relationship': 'リレーションシップ',
      'entity_stix-sighting-relationship': '目撃',
      entity_Identity: 'アイデンティティ',
      entity_Location: 'ロケーション',
      entity_Event: 'イベント',
      entity_Relationship: 'リレーションシップ',
      'entity_Marking-Definition': 'データマーキング (TLP)',
      'entity_External-Reference': '外部参考資料',
      entity_Label: 'ラベル',
      ...
      entity_Stixfile: 'ファイル',
      'entity_X509-Certificate': 'X.509 証明書',
      ...
      relationship_obs_content: 'コンテンツ',
      'relationship_resolves-to': '名前解決される',
      'relationship_obs_resolves-to': '名前解決される',
      'relationship_belongs-to': '属している',
      'relationship_obs_belongs-to': '属している',
      'relationship_cooperates-with': '協力',
      'relationship_participates-in': '参加',
      relationship_contains: '含む',
      relationship_values: '値',
      'relationship_stix-sighting-relationship': '目撃した',
      'relationship_external-reference': '外部参照した',
      ...
      'relationship_revoked-by': '取り消された',
      relationship_delivers: '配信',
      relationship_targets: '標的',
      relationship_uses: '使用した',
      relationship_publishes: '発行',
      relationship_amplifies: '増幅する',
      'relationship_attributed-to': '帰属する',
      relationship_compromises: '侵害',
      'relationship_originates-from': '起因する',
      relationship_investigates: '調査',
      relationship_mitigates: '軽減',
      'relationship_located-at': '位置する',
      relationship_indicates: '指し示す',
      'relationship_based-on': '基づく',
      'relationship_communicates-with': '通信する',
      'relationship_consists-of': '構成される',
      relationship_controls: 'コントロール',
      'relationship_relation-has': '持つ',
      relationship_hosts: 'ホストする',
      relationship_owns: '所有する',
      'relationship_authored-by': '作成された',
      'relationship_beacons-to': 'ビーコン通信をした',
      'relationship_exfiltrates-to': '抽出した',
      relationship_downloads: 'ダウンロード',
      relationship_drops: 'ドロップ',
      relationship_exploits: 'エクスプロイット',
      'relationship_variant-of': '亜種の',
      relationship_characterizes: '特徴付ける',
      'relationship_analysis-of': '解析による',
      'relationship_static-analysis-of': '静的解析による',
      'relationship_dynamic-analysis-of': '動的解析による',
      relationship_impersonates: 'なりすました',
      relationship_remediates: '修正する',
      'relationship_related-to': '関連する',
      'relationship_derived-from': '配信された',
      ...
      director: 'ディレクター',
      independent: '無所属',
      'infrastructure-architect': 'インフラストラクチャ 設計者',
      'infrastructure-operator': 'インフラストラクチャ 運用者',
      'malware-author': 'マルウェア作成者',
      sponsor: 'スポンサー',
      status_NEW: '新規',
      status_IN_PROGRESS: '進行中',
      status_ANALYZED: '解析完了',
      status_CLOSED: '終了済',
      status_PENDING: 'ペンディング',
      status_TO_BE_QUALIFIED: '取り掛かる',
      organization_constituent: '組織員',
      organization_csirt: 'CSIRT',
      organization_partner: 'パートナー',
      organization_vendor: 'ベンダー',
      organization_other: 'その他',
      filter_container_type: '分析のタイプ',
      filter_basedOn: '観測結果をベースにする',
      filter_sightedBy: '目撃した',
      filter_entity_type: 'エンティティタイプ',
      filter_relationship_type: 'リレーションシップタイプ',
      filter_pattern_type: 'インディケータタイプ',
      filter_x_opencti_main_observable_type: '観測結果のタイプ',
      filter_labelledBy: 'ラベル',
      filter_createdBy: '作成者',
      filter_markedBy: 'データマーキング (TLP)',
      filter_containedBy: '分析者',
      filter_x_opencti_workflow_id: 'ステータス',
      filter_report_types: 'レポートタイプ',
      filter_channel_types: 'チャネルタイプ',
      filter_confidence_gt: '確証度が大きい',
      filter_published_start_date: '発行時間 (開始)',
      filter_published_end_date: '発行時間 (終了)',
      filter_created_start_date: '作成時間 (開始)',
      filter_created_end_date: '作成時間 (終了)',
      filter_created_at_start_date: '作成時間 (開始)',
      filter_created_at_end_date: '作成時間 (終了)',
      filter_modified_start_date: '変更時間 (開始)',
      filter_modified_end_date: '変更時間 (終了)',
      filter_valid_from_start_date: '有効期限 (開始)',
      filter_valid_until_end_date: '有効期限 (終了)',
      filter_x_opencti_score_gt: 'スコアより大きい',
      filter_x_opencti_score_lte: 'スコア以下',
      filter_x_opencti_detection: '検知',
      filter_x_opencti_base_score_gt: 'CVSS3 スコア (以上)',
      filter_x_opencti_base_severity: 'CVSS3 重要度',
      filter_x_opencti_attack_vector: 'CVSS3 攻撃ベクタ',
      filter_toCreatedAt_start_date: '作成日 (開始)',
      filter_toCreatedAt_end_date: '作成日 (終了)',
      filter_x_opencti_organization_type: '組織名',
      filter_indicates: '指し示す',
      filter_revoked: '取り消された',
      filter_toSightingId: '目撃',
      ...
      eql: 'Elastic EQL',
      'Apply on': '適用',
      'Retention policies': 'リテンションポリシー',
      'Max retention': '最大保持日数',
      'Maximum retention days': '最小保持日数',
      'Last execution': '最終実行日',
      'Create a retention policy': 'リテンションポリシーの作成',
      'Update a retention policy': 'リテンションポリシーの更新',
      'day(s)': '日',
      Everything: '全ての項目',
      true: 'はい',
      false: 'いいえ',
      ...
      'Clear all works': '全てのワークを削除',
      'Do you want to reset the state of this connector?':
        'このコネクタの状態をリセットしたいですか?',
      Reset: 'リセット',
      'Do you want to clear the works of this connector?':
        'このコネクタの情報を削除したいですか?',
      disagree: 'いいえ',
      ...
      agree: 'はい',
      'suggestion_threats-indicators':
        'インディケータと脅威に `indicates` リレーションシップを作成したあと、全てのリレーションシップをコンテナに追加する。',
      /*** END mina ***/
    },
    'zh-cn': {
      // Titles
