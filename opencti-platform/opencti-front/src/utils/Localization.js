const i18n = {
  messages: {
    ...
    'ja-jp': {
      ...
      'Number of relationships': '関連数',
      'Live streams': 'ライブストリーム',
      'Feeds (CSV)': 'フィード (CSV)',
      'Rolling time': 'ローリングタイム',
      'Rolling time (in minutes)': 'ローリングタイム(分)',
      ...
      'Operations completed': '完了した作業',
      'Total number of operations': '作業の総数',
      // Properties
      Entity: 'エンティティ',
      Widget: 'ウィジェット',
      Size: 'サイズ',
      ...
      'Is family': 'ファミリ',
      'Is family?': 'ファミリ？',
      'Architecture execution env.': 'アーキテクチャの実行環境',
      'Implementation languages': '実装言語',
      'This sector does not have any description.':
        'このセクターには説明がありません',
      'Relationship type': '関連タイプ',
      'From type': 'ソースタイプ',
      'From name': 'ソース名',
      'To type': 'ターゲットタイプ',
      'To name': 'ターゲット名',
      ...
      'Creation date (in this platform)':
        '作成日(プラットフォーム上で)',
      'Technical date': '技術日程',
      'Functional date': '機能日程',
      'Date reference': '日付参照',
      'Modification date': '変更日',
      'Updated the': '更新情報',
      'Update entities': '更新エンティティ',
      Creator: '作成者',
      Validate: '有効期限',
      Marking: 'マーキング',
      ...
      name: '名前',
      'Threat actor types': '脅威アクターの種類',
      'Malware types': 'マルウェアの種類',
      Revoked: '失効',
      ...
      Start: '開始',
      Stop: '停止',
      'Verify SSL certificate': 'SSL証明書の検証',
      Confirmation: '確認',
      'Kill chain': 'キルチェーン',
      'This feature is not available yet.':
        'この機能はまだ利用できません',
      ...
      'Targeted countries (3 last months)': '対象国（過去3ヶ月）',
      Publication: '公開',
      'Entity type': 'エンティティタイプ',
      'Report type': 'レポートの種類',
      'Report types': 'レポートの種類',
      ...
      Goals: '目標',
      'Goals (1 / line)': '目標 (1 / 行)',
      'Log sources (1 / line)': 'ログソース(1 / 行)',
      'Observable value': '観測結果の値',
      'Observable type': '観測結果の種類',
      'Observable types': '観測結果の種類',
      'Indicator type': 'インジケータの種類',
      'Indicator types': 'インジケータの種類',
      'Main observable type': '主な観測結果の種類',
      ...
      'X509 Certificates': 'X509証明書',
      Registry: 'レジストリ',
      'Registry key': 'レジストリキー',
      'Registry key value': 'レジストリキーの値',
      'File hash': 'ファイルハッシュ',
      ...
      'Averages of context relations': 'コンテキスト関連の平均',
      ...
      'Read operations': '読み込み操作',
      'Write operations': '書き込み操作',
      'Platform login message': 'プラットフォームログインメッセージ',
      'Global streams are available for granted users. Live at /stream/live and raw at /stream':
        'グローバルストリームが許可されたユーザーで利用可能です。ライブは/stream/live、rawは/streamから利用してください。',
      Write: '書き込み',
      Preview: 'プレビュー',
      'Graph type': 'グラフタイプ',
      ...
      'Relations to threats': '脅威との関連性',
      'Relations to other entities': '他のエンティティとの関連性',
      'Context relations': 'コンテキストとの関連性',
      'Direct relations creations': '直接的な関連の作成',
      'Number of target relations': '対象の関連の数',
      'Total entities': 'エンティティの総数',
      'Total relationships': '関連の総数',
      Relationship: '関連',
      'Total observables': '観測結果の総数',
      'Total reports': 'レポートの総数',
      'Total workspaces': 'ワークスペースの総数',
      'Total notes': 'ノートの総数',
      'Total relations': '関連の総数',
      'Total indicators': 'インジケータの総数',
      'Total direct relations': '直接的な関連の総数',
      'Top Labels (3 last months)': '上位のラベル(過去3ヶ月)',
      'Last ingested reports (creation date in the platform)':
        '最後に取り込まれたレポート(プラットフォームでの作成日)',
      ...
      'Distribution of relations (including inferred)':
        '関連(推論を含む)の分布',
      'Distribution of relations': '関連の分布',
      'Distribution of sources': 'ソースの分布',
      'Latest created relationships': '最後に作成された関連',
